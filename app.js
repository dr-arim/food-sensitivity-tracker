...
class GutHealthTracker {
    ...
    processRedFlagChecklist() {
        processRedFlagChecklist() {
    console.log('Red-flag form submitted!'); // Debug line
    ...
    console.log('Form responses:', responses); // Debug line

    // Check if any response is 'yes'
    const hasRedFlags = Object.values(responses).includes('yes');
    
    console.log('Has red flags:', hasRedFlags); // Debug line
    ...
    console.log('Proceeding to symptom tracking...'); // Debug line
